...
CREATE INDEX IF NOT EXISTS FOR (n:MdeHost) ON (n.id);
CREATE INDEX IF NOT EXISTS FOR (n:MdeHost) ON (n.instance_id);
CREATE INDEX IF NOT EXISTS FOR (n:MdeHost) ON (n.lastupdated);
